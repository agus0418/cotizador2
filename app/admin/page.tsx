        ...
        <Card className="w-full max-w-md shadow-lg border-[#2C588F]/20">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-center flex items-center justify-center gap-2">
              <LockIcon className="h-6 w-6 text-[#2C588F]" />
  ...
  return (
    <div className="container mx-auto py-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-[#2C588F] flex items-center gap-2">
      ...
      <Tabs defaultValue="sucursales" className="space-y-6">
        <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-2 bg-muted/50 p-1">
          <TabsTrigger value="sucursales" className="flex items-center gap-2 data-[state=active]:bg-[#2C588F] data-[state=active]:text-white">
            <Building className="h-4 w-4" />
            <span className="hidden md:inline">Sucursales</span>
          </TabsTrigger>
          <TabsTrigger value="tipos-paquete" className="flex items-center gap-2 data-[state=active]:bg-[#2C588F] data-[state=active]:text-white">
            <Package className="h-4 w-4" />
            <span className="hidden md:inline">Tipos de Paquete</span>
          </TabsTrigger>
          <TabsTrigger value="tarifas" className="flex items-center gap-2 data-[state=active]:bg-[#2C588F] data-[state=active]:text-white">
            <Calculator className="h-4 w-4" />
            <span className="hidden md:inline">Tarifas</span>
          </TabsTrigger>
          <TabsTrigger value="rutas" className="flex items-center gap-2 data-[state=active]:bg-[#2C588F] data-[state=active]:text-white">
        ...
        <TabsContent value="tipos-paquete" className="space-y-4">
          <AdminTiposPaquete />
        </TabsContent>
